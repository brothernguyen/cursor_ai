 ...
 * Set your Supabase project URL and anon key for production.
 */
export const environment = {
  ...
  /** Set to a same-origin path + host proxy if deployed static build hits FunctionsFetchError. */
  supabaseFunctionsFetchProxyPrefix: '',
